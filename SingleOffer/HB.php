...
<html>
    <head>
        <title>Add HB Single Offer</title>
        <meta charset="utf-8">
    ...
    <body class="hold-transition skin-blue sidebar-mini"> 
        <div class="wrapper">  
            ...
            <header class="main-header">		    
                <!-- Logo --> 
                <a href="./HB.html" class="logo"> 
                    <!-- mini logo for sidebar mini 50x50 pixels --> 
                    <span class="logo-mini"><b>B</b>KN</span> 
                    <!-- logo for regular state and mobile devices --> 
                    <span class="logo-lg"><b>HB Single Offer</b></span> </a> 			    
                <!-- Header Navbar -->
      ...
      <div class="row">           
          ...
          <div class="col-md-10 ">
              ...
              <div class="box box-info ">
                  ...
                  <form action="HBSingleOffer.php" name="add_static_page" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                  <div class="box-body">
                  ...
                  <div class="box-footer">
                      ...
                      <button class="btn btn-info pull-right" type="submit" name="hb_add">ADD</button>
                  </div>    					
                  </form>	
              </div><!-- /.box -->             
          </div><!--/.col (right) -->
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////// -->
            ...
            <footer class="main-footer"> 
                ...
                <!-- Default to the left --> 
                <strong>Copyright &copy; 2024 <a href="https://www.holidaybuzz.co.uk/">Holidaybuzz</a>.</strong> All rights reserved. </footer>
