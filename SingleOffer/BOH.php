...
<html>
    <head>
        <title>Add BOH Single Offer</title>
        <meta charset="utf-8">
        ...
        <div class="wrapper">  
            ...
            <header class="main-header">		    
                ...
                <a href="https://emails.bestonlineholidays.co.uk/admin/index" class="logo"> 
                    ...
                    <span class="logo-lg"><b>BOH Single Offer</b></span> </a> 			    
                <!-- Header Navbar -->
                ...
                <section class="sidebar"> 
                    ...
                    <ul class="sidebar-menu">
                        <!-- Optionally, you can add icons to the links -->
                                                    ...
                                                    <li class=""><a href="./BOH.php"><i class="fa fa-table"></i> <span>BOH Dashboard</span></a></li>	        
    ...
    <section class="content-header">
      <h1>Add BestonlineHolidays offer</h1>
      <ol class="breadcrumb">
          <li><a href=""><i class="fa fa-dashboard"></i>Home</a></li>
          <li><a href="https://emails.bestonlineholidays.co.uk/admin/destinations">BOH Pages</a></li>
      ...
      <div class="row">           
          ...
          <div class="col-md-10 ">
              ...
              <div class="box box-info ">
                  <!-- /.box-header -->
                  <!-- form start -->
                  <form action="BOHSingleOffer.php" name="add_static_page" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                  <div class="box-body">
                  ...
                  <div class="box-footer">
                      ...
                      <button class="btn btn-info pull-right" type="submit" name="boh_add">ADD</button>
                  </div>    					
                  </form>	
              </div><!-- /.box -->             
          </div><!--/.col (right) -->
            ...
            <footer class="main-footer"> 
                ...
                <!-- Default to the left --> 
                <strong>Copyright &copy; 2024 <a href="#">Bestonlineholidays</a>.</strong> All rights reserved. </footer>
