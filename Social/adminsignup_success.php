...
<body >
	...
	<form method="post" action="" enctype = "multipart/form-data">
		...
		<div style="position:absolute;left:81.8%;top:5.2%; "><button class="btn btn-primary" type="button" name="adminLogin" value="Log In" id="login_button1" style="height:28px; width:auto; padding-top:1px;">Log In</button>  </div>
	</form>
    ...
    <div style="position:absolute; left:7%; top:24%; color:#3B5998; font-size:28px; width:auto; height:10%"> <font face="poppins"> Congratulations!<?php echo "$admin_data[adminfirstname]"?>.... Your admin account has been created successfully. </font> </div>
