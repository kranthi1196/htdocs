<?php
	/* Database & redirection related files */
...
<body>
	...
	<form method="POST" action="" enctype = "multipart/form-data">
		...
		<div style="position:absolute; left:57.7%; top:5.18%; font-size:11px;"> <input type="text" class="form-control" name="adminusername" style="width:149.5; height:28px;"/> </div>
		...
		<div style="position:absolute;left:69.6%; top:5.18%; font-size:13px; "> <input type="password" class="form-control" name="adminpassword" style="width:149.5; height:28px; padding-bottom:5px;"> </div>
		...
		<div style="position:absolute;left:81.8%;top:5.2%; "><button class="btn btn-primary" type="submit" name="adminLogin" value="Log In" id="login_button1" style="height:28px; width:auto; padding-top:1px;">Log In</button>  </div>
	</form>
	...
	<!-- Faceback left part -->
		...
		<!--Left part-->
		<!--Mobile Image-->
	<div style="position:absolute; left:5%; top:35%;"> <img src="./images/admin.jpg" width="700" height="275"> </div>
    <div style="position:absolute; left:7%; top:24%; color:#3B5998; font-size:28px; width:700;"> <font face="poppins"> Link-Up Admin Registration </font> </div>
...
<!--============================================== Registration Section ==============================================-->
	...
	<form  method="post" onSubmit="return check();" name="Reg">
		<div style="position:absolute;left:58%; top:18.5%; color:#000066; font-size:25"> <h5>Admin Sign Up </h5> </div>
		...
		<div style="position:absolute;left:65.2%; top:32.8%; "> <input type="text" class="form-control" name="adminfirstname"  maxlength="15" placeholder="First Name" style="width:255px;"/> </div>
		...
		<div style="position:absolute;left:65.2%;  top:39.8%; "> <input type="text" class="form-control" name="adminlastname"  maxlength="15" placeholder="Last Name" style="width:255px;"/> </div>
		...
		<div style="position:absolute;left:65.2%;  top:46.8%; "> <input type="text" class="form-control" name="adminemail"  maxlength="50" placeholder="Email Address" style="width:255px;"/> </div>

		<div style="position:absolute;left:59.4%; top:57%; font-size:16px; color:#000000"><i class="fas fa-envelope fa-lg me-3 fa-fw"></i></div>
		<div style="position:absolute;left:65.2%; top:53.8%; "> <input type="text" class="form-control" name="adminremail"  maxlength="50" placeholder="Confirm Email Address" style="width:255px;"/> </div>

		<div style="position:absolute;left:59.4%; top:64%; font-size:16px; color:#000000"><i class="fas fa-lock fa-lg me-3 fa-fw"></i></div>
		<div style="position:absolute;left:65.2%; top:60.8%; "> <input type="password" class="form-control" name="adminpassword"  maxlength="15" placeholder="Create a Password" style="width:255px;"/> </div>
		...
		<select class="select col-md-8 mb-4 form-control" name="adminsex" style="width:255px;height:35px;font-size:18px;padding:3;color:#6c757d;padding-left:12px">
...
<div style="position:absolute;left:59.4%; top:76.8%; font-size:16px; color:#000000"><i class="fas fa-birthday-cake fa-lg me-3 fa-fw"></i></div>
	...
	<select class="form-control" name="adminmonth" style="width:85px;font-size:18px;height:32;padding:1;color:#6c757d;padding-left:12px">
	...
	<select name="adminday" class="form-control" style="width:85px;font-size:18px;height:32;padding:1; color:#6c757d;padding-left:12px">
	...
	<select name="adminyear" class="form-control" style="width:85px; font-size:18px; height:32; padding:1; color:#6c757d;padding-left:12px">
