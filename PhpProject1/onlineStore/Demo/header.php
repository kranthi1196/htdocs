...
<body>
    ...
    <header>
        ...
        <div id="top-header">
            <div class="container">
                <ul class="header-links pull-left"> <!-- Top left Icons Bar -->
                ...
                <ul class="header-links pull-right"> <!-- Top right icons bar -->
                    <li><a href="#"><i class="fa fa-inr"></i> INR</a></li>
                    <li><?php
						
                             include "db.php";
                            if(isset($_SESSION["uid"])){   /* User name on Top Right Corner after logged in */
                            ...
                            }else{ /* User Options on Top Right Corner if he is not logged in */
                                echo '
                                <div class="dropdownn">
