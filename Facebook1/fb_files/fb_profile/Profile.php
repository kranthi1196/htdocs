...
<?php
	$que_post_img=mysqli_query($connect, "select * from user_post where user_id=$userid and post_pic!='' order by post_id desc");
...
<?php
	$que_post_bg1=mysqli_query($connect, "select * from user_post where user_id=$userid");
...
<table cellspacing="0">
<?php
	$que_post=mysqli_query($connect, "select * from user_post where user_id=$userid order by post_id desc");
...
<?php
	$user_info_query=mysqli_query($connect, "select * from user_info where user_id=$userid");
