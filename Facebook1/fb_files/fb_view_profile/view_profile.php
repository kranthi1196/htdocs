...
<?php
	$que_post_bg1=mysqli_query($connect, "select * from user_post where user_id=$v_user_id");
...
<table cellspacing="0">
<?php
	$que_post=mysqli_query($connect, "select * from user_post where user_id=$v_user_id and priority='Public' order by post_id desc");
...
<?php
	$user_info_query=mysqli_query($connect, "select * from user_info where user_id=$v_user_id");
...
<?php
	$que_post_img=mysqli_query($connect, "select * from user_post where user_id=$v_user_id and post_pic!='' and priority='Public' order by post_id desc");
