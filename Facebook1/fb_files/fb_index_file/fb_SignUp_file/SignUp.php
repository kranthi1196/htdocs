...
if(isset($_POST['signup']))
{
	...
	$que1=mysqli_query($connect, "select * from users where Email='$Email'");
	...
	else
	{
		...
		{
			$que2=mysqli_query($connect, "insert into users(Name,Email,Password,Gender,Birthday_Date,FB_Join_Date) values('$Name','$Email','$Password','$Gender','$Birthday_Date','$FB_Join_Date')");
