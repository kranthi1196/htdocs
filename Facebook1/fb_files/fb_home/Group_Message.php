<?php
	...
	if(isset($_SESSION['fbuser']))
	{
		...
		if(isset($_POST['Message_send']))
		{
			...
			mysqli_query($connect, "insert into group_chat(user_id,chat_txt,time) values($userid,'$chat_txt','$chat_time')");
		}
		
		if(isset($_POST['delete_chat']))
		{
			$chat_id=intval($_POST['chat_id']);
			mysqli_query($connect, "delete from group_chat where chat_id=$chat_id");
		}
...
<?php
		$que_chat=mysqli_query($connect, "select * from group_chat order by chat_id desc");
?>
