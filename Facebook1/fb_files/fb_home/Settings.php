...
<?php
	if(isset($_POST['change_name']))
	{
		...
		mysqli_query($connect, "update users set Name='$Name' where user_id=$userid;");
	...
	if(isset($_POST['change_password']))
	{
		...
		{
			mysqli_query($connect, "update users set Password='$new_password' where user_id=$userid;");
		}
		else
		{
	...
	{
		$uid=$_POST['uid'];
		mysqli_query($connect, "delete from users where user_id=$uid;");
