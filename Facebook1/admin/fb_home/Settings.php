<?php
	...
	$connect = @mysqli_connect("localhost","root","","faceback1");
		...
		$que_admin_info=mysqli_query($connect, "select * from admin_info where Username='$admin_user'");
...
<?php
	if(isset($_POST['change_password']))
	{
		...
		{
			mysqli_query($connect, "update admin_info set Password='$new_password' where Username='$admin_user'");
		}
		else
		{
