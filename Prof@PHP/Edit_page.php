...
?>
    ...
    <form action="preview_Dup.php" method="post" enctype = "multipart/form-data">
        ...
        <table>
    <tr><br><td><b>Unique Identification Number (UID)/Aadhar Number * : </td><td><input type="text" name="uid"   onKeyup="this.value = this.value.toUpperCase()" value="<?php $max_row[uid]?>"></b></td></tr>
