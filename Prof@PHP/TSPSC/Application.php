...
<body>
    ...
    <p style="text-align:center"><h4 >You Are Logged in As : <?php echo "$reg_data[fname] $reg_data[lname]"?><span> <input type="Submit" name="logout" value="Logout"></span></h4></p> 
</form>
<br>
    <form action="" method="post" enctype = "multipart/form-data">
        <fieldset>
        ...
        <table>
    <tr><br><td><b>Unique Identification Number (UID)/Aadhar Number * : </td><td><input type="text" name="uid"   onKeyup="this.value = this.value.toUpperCase()" placeholder="7913 9305 5275"></b></td></tr>
    <tr><td><b>TSPSC ID * :</td> <td><input type="text" name="tspscid"   onKeyup="this.value = this.value.toUpperCase()" placeholder="TS029"></b></td></tr>
    <!-- <tr><td><b>Reference ID :</td><td><input type="text" name="refid" onKeyup="this.value = this.value.toUpperCase()" placeholder="Dont Fill This"></b></td></tr>-->
    <tr><td><b>Candidate Name * :</td><td><input type="text" name="cand_name"   onKeyup="this.value = this.value.toUpperCase()" placeholder="KRANTHI KUMAR MARIKANTI"></b></td></tr>
    <tr><td><b>Father's/Husband's Name :</td><td><input type="text" name="fath_hus_name" id="" onKeyup="this.value = this.value.toUpperCase()" placeholder="SANJEEVA MARIKANTI"></b></td></tr>
    <tr><td><b>Mother's Name :</td><td><input type="text" name="mother_name" onKeyup="this.value = this.value.toUpperCase()" placeholder="RAMANA MARIKANTI"></b></td></tr> 
    <tr><td><b>Date of Birth * :</td><td><input type="calender" name="dob"   onKeyup="this.value = this.value.toUpperCase()" placeholder="15/03/1993"></b></td></tr> 
    ...
    <tr><td><b>Address for Communication :</td><td><input type="textarea" name="address" id="" onKeyup="this.value = this.value.toUpperCase()" placeholder="4-140, THALLASINGARAM, NUTHANKAL, SURYAPET"></b></td></tr> 
    <tr><td><b>District :</td><td><input type="text" name="district" id="" onKeyup="this.value = this.value.toUpperCase()" placeholder="SURYAPET"></b></td></tr> 
    <tr><td><b>Mandal :</td><td><input type="text" name="mandal" onKeyup="this.value = this.value.toUpperCase()" placeholder="NUTHANKAL"></b></td></tr> 
    <tr><td><b>Village :</td><td><input type="text" name="village" id="" onKeyup="this.value = this.value.toUpperCase()" placeholder="THALLSINGARAM"></b></td></tr> 
    <tr><td><b>Pincode :</td><td><input type="text" name="pincode" onKeyup="this.value = this.value.toUpperCase()" placeholder="508221"></b></td></tr> 
    <tr><td><b>Mobile Number * :</td><td><input type="text" name="mobile" id=""   onKeyup="this.value = this.value.toUpperCase()" placeholder="9640735588"></b></td></tr> 
    ...
    <tr><td><b>Identification Marks as per SSC Certificate :</td><td><input type="text" name="identication_marks" id="" onKeyup="this.value = this.value.toUpperCase()" placeholder="A MOLE ON THE LEFT LEG"></b></td></tr> 
...
<fieldset>
    ...
    <tr><td><b>University :</b></td><td><input type="text" name="university" id="" onKeyup="this.value = this.value.toUpperCase()" placeholder="JNTU-H"></td></tr>
    <tr><td><b>Date of Acquiring Qualification :</b></td><td><input type="text"  name="doa" id="" onKeyup="this.value = this.value.toUpperCase()" placeholder="25/05/2016"></td></tr>
    <tr><td><b>Hallticket No. of Degree Examination * :</b></td><td><input type="text"   name="deg_htnum" id="" onKeyup="this.value = this.value.toUpperCase()" placeholder="12631A0423"></td></tr>
...
<fieldset>
    ...
    <tr><td><b>Degree :</b></td><td>
        ...
        <option name="sortfilter" value="YADADRI BHUVANAGIRI">YADADRI BHUVANAGIRI</option>
         ...
         &nbsp; &nbsp;<input type="text" name="degree_mandal_loc" id="" onKeyup="this.value = this.value.toUpperCase()" placeholder="Mandal / Muncipality">&nbsp; &nbsp;<input type="text" name="degree_village_loc" id="" onKeyup="this.value = this.value.toUpperCase()" placeholder="Village/ Area / Ward "></td></tr>
         ...
         <tr><td><b>Intermediate :</b></td><td>
            <select name="inter_loc" id="" >
             ...
             &nbsp; &nbsp;<input type="text" name="inter_mandal_loc" id="" onKeyup="this.value = this.value.toUpperCase()" placeholder="Mandal / Muncipality">&nbsp; &nbsp;<input type="text" name="inter_village_loc" id="" onKeyup="this.value = this.value.toUpperCase()" placeholder="Village/ Area / Ward "></td></tr>
        ...
        <option name="sortfilter" value="YADADRI BHUVANAGIRI">YADADRI BHUVANAGIRI</option>
                 ...
                 &nbsp; &nbsp;<input type="text" name="ssc_mandal_loc" id="" onKeyup="this.value = this.value.toUpperCase()" placeholder="Mandal / Muncipality">&nbsp; &nbsp;<input type="text" name="ssc_village_loc" id="" onKeyup="this.value = this.value.toUpperCase()" placeholder="Village/ Area / Ward "></td></tr>
        ...
        <option name="sortfilter" value="YADADRI BHUVANAGIRI">YADADRI BHUVANAGIRI</option>
                     ...
                     &nbsp; &nbsp;<input type="text" name="cls9_mandal_loc" id="" onKeyup="this.value = this.value.toUpperCase()" placeholder="Mandal / Muncipality">&nbsp; &nbsp;<input type="text" name="cls9_village_loc" id="" onKeyup="this.value = this.value.toUpperCase()" placeholder="Village/ Area / Ward "></td></tr>
        ...
        <option name="sortfilter" value="YADADRI BHUVANAGIRI">YADADRI BHUVANAGIRI</option>
                         ...
                         &nbsp; &nbsp;<input type="text" name="cls8_mandal_loc" id="" onKeyup="this.value = this.value.toUpperCase()" placeholder="Mandal / Muncipality">&nbsp; &nbsp;<input type="text" name="cls8_village_loc" id="" onKeyup="this.value = this.value.toUpperCase()" placeholder="Village/ Area / Ward "></td></tr>
        ...
        <option name="sortfilter" value="YADADRI BHUVANAGIRI">YADADRI BHUVANAGIRI</option>
                             ...
                             &nbsp; &nbsp;<input type="text" name="cls7_mandal_loc" id="" onKeyup="this.value = this.value.toUpperCase()" placeholder="Mandal / Muncipality">&nbsp; &nbsp;<input type="text" name="cls7_village_loc" id="" onKeyup="this.value = this.value.toUpperCase()" placeholder="Village/ Area / Ward "></td></tr>
        ...
        <option name="sortfilter" value="YADADRI BHUVANAGIRI">YADADRI BHUVANAGIRI</option>
                                 ...
                                 &nbsp; &nbsp;<input type="text" name="cls6_mandal_loc" id="" onKeyup="this.value = this.value.toUpperCase()" placeholder="Mandal / Muncipality">&nbsp; &nbsp;<input type="text" name="cls6_village_loc" id="" onKeyup="this.value = this.value.toUpperCase()" placeholder="Village/ Area / Ward "></td></tr>
...
<fieldset>
    ...
    <table>
        <tr><td><b>Journal Number * :</b></td><td><input type="text"   name="journal_num1" id="" onKeyup="this.value = this.value.toUpperCase()" placeholder="TSPSC12345678932"></td></tr>
        <tr><td><b>Payment Date * :</b></td><td><input type="text"   name="payment_date" id="" onKeyup="this.value = this.value.toUpperCase()" placeholder="01/09/2016"></td></tr>
        <tr><td><b>Amount * :</b></td><td><input type="text"   name="fee" id="" onKeyup="this.value = this.value.toUpperCase()" placeholder="200.0"></td></tr>
...
<fieldset>
    ...
    <table>
        ...
        <tr><td><b>Preference 10 :</b></td><td><select name="pref_10" id="" >
            <option name="sortfilter" value="Select">Select Exam Center10</option>
            <option name="sortfilter" value="ADILABAD">ADILABAD</option>
        <option name="sortfilter" value="HYDERABAD">HYDERABAD</option>
        <option name="sortfilter" value="KARIMNAGAR">KARIMNAGAR</option>
        <option name="sortfilter" value="KHAMMAM">KHAMMAM</option>
...
<center><input type="submit" name="app_submit" id="" value="submit"></center>
