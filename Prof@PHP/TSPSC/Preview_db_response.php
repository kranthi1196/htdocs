...
$table_app = "CREATE TABLE IF NOT EXISTS $table_name_app(`id` INT(10) NOT NULL AUTO_INCREMENT, `uid` VARCHAR(255) NOT NULL,
...
if(!empty($uid) && !empty($tspscid) && !empty($refid)){
    ...
    $query = "INSERT INTO $table_name_app(`uid`, `tspscid`, `refid`,
...
if($app_data = mysqli_fetch_assoc($query_ex))
{
   ...
   /* print "<table border=\"1px\">
    ...
    <tr> <td> <img src = $table_name_app/$max_row[cand_image]><br></td></tr>
    <tr> <td> <img src = $table_name_app/$max_row[cand_sign]><br></td></tr>
    </table>";
