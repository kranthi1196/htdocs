...
<body>
    ...
    print "<center> <img class=\".emblem\" src=\"./Images/TSPSC_Logo.png\" alt=\"Telangana State Logo\" width=\"100px\" height=\"100px\" padding-top=\"10px\"></center>";

    print "<center><h3>TELANGANA STATE PUBLIC SERVICE COMMISSION :: HYDERABAD</h3>
    <h4>GROUP-II SERVICES</h4>
    <h4>(GENERAL RECRUITMENT)</h4>
    <h4>SUPPLEMENTARY NOTIFICATION NO. 17/2016 TO NOTIFICATION NO. 20/2015, Dated.01/09/2016</h4></center>";
    print "<table border=1px><tr><td>1. </td><td rowspan=\"2\">Unique Identification Number (UID)/Aadhar Number :</td><td>$uid</td><td colspan=\"5\"></td></tr></table>";
    print "<table border=1px><tr><td>2. </td><td >TSPSC ID :</td><td>$tspscid</td><td>3. </td><td>$refid</td><td>..</td></tr></table>";

    //<tr><td></td><td></td><td></td><td></td></tr>
    //echo 'Your Aadhar Number is: '.$uid;
