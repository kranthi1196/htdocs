...
$loginrow = "row login-row bg-primary";
// $icon="`<i class="bi bi-person-circle"></i>`";

// Apply these classes to the logo area if the login page is left or right
$lrArr = ['center'];
$formarea .= (in_array($GLOBALS['login_page_layout'], $lrArr)) ? " col-md-6" : " col-md-6";
$logoarea .= (in_array($GLOBALS['login_page_layout'], $lrArr)) ? " col-md-6" : " col-md-6";
// $icon .=
